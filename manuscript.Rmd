...
##data cleaning is very concise and efficient!! 

```{r, include = FALSE}
# import functions
source("functions.R") ## semms very useful! Made a note for myself
...
#probably a good idea to create a function that you can reuse, especially since random effect structure is the same 
