...
All analyses were conducted in R’s lme4 package (Bates et al., 2013). The
...
Since the model for normative thought accuracy is singular, we ran the models separately.
...
df_thought_long <- split(df_thought2, df_thought2$vars)

models5 <- map_dfr(df_thought5, ~
            lmer(judgment ~ value +
             (1 | perceiver_id) + 
             (1 | target_id) +
             (1 | dyad_id),
