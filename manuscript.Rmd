...
## Descriptive statistics for Empathic Accuracy
```{r}
descriptive_df <-
df %>% 
  select(
...
## Variance decomposition in interpersonal accuracy for thoughts, affect, and personality traits

```{r}
# personality
samdata <- rio::import(here::here("data", "samdata.csv"))
...
```{r}
# affect
samEACaggdata <- rio::import(here::here("data", "samdata.csv"))
...
## Interpersonal accuracy for thoughts, affect, and personality traits
...
colnames(EBTRTtar)<-c("Intercept","TSR","Norm")
...
## Density plots for random effects will be here
